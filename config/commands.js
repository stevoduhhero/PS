...
var commands = exports.commands = {
	...
	tiers: function(target, room, user) {
		...
		if (!target) {
			matched = true;
			this.sendReplyBox('- <a href="http://www.smogon.com/bw/tiers/" target="_blank">Information on the various Standard Tiers</a><br />');
		}
		if (target === 'ou' || target === 'overused') {
           		matched = true;
           		this.sendReplyBox('- <a href="http://www.smogon.com/bw/metagames/ou" target="_blank">OU Metagame Analyses</a><br />' +
           		 	'- <a href="http://www.smogon.com/forums/forumdisplay.php?f=203" target="_blank">OU\'s Smogon Forums Thread</a><br />');
		}
		if (target === 'uu' || target === 'underused') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://www.smogon.com/bw/metagames/uu" target="_blank">UU Metagame Analyses</a><br />' +
            		 	'- <a href="http://www.smogon.com/forums/forumdisplay.php?f=170" target="_blank">UU\'s Smogon Forums Thread</a><br />');
		}
		if (target === 'ru' || target === 'rarelyused') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://www.smogon.com/bw/metagames/ru" target="_blank">RU Metagame Analyses</a><br />' +
            		 	'- <a href="http://www.smogon.com/forums/forumdisplay.php?f=178" target="_blank">RU\'s Smogon Forums Thread</a><br />');
		}
		if (target === 'nu' || target === 'neverused') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://www.smogon.com/bw/metagames/nu" target="_blank">NU Metagame Analyses</a><br />' +
            			'- <a href="http://www.smogon.com/forums/forumdisplay.php?f=185" target="_blank">NU\'s Smogon Forums Thread</a><br />');
		}
		if (target === 'pu') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://www.smogon.com/forums/showthread.php?t=3467083" target="_blank">PU\'s Other Metagame Thread</a><br />' +
            			'- <a href="http://www.smogon.com/forums/showthread.php?t=3483077" target="_blank">PU\'s Viability Ranking Thread</a><br />');
		}
		if (target === 'pokecybertiers' || target === 'pctiers') {
            		matched = true;
            		this.sendReplyBox('- <a href="https://docs.google.com/document/d/1GDgeBP0am-jXtA-8HggBvveA40yW9a3PqRdw3Me-0wc/edit?usp=sharing" target="_blank">PokeCyber Tiers Change Log</a><br />');
		}
		if (target === 'generation6' || target === 'g6' || target === 'gen6') {
            		matched = true;
            		this.sendReplyBox('- <a href="https://github.com/stevoduhhero/PS/blob/master/mods/gen6/README.md">Generation 6 Abillities and Moves Changes</a><br />');
		}		
		if (target === 'smogondoubles' || target === 'standarddoubles' || target === 'doubles') {
            		matched = true;
            		this.sendReplyBox('- <a href="http://www.smogon.com/forums/forumdisplay.php?t=3476469" target="_blank">Smogon Doubles\'s Other Metagame Thread</a><br />');
		}
		if (target === 'cap' || target === 'createapokemon') {
            		matched = true;
		...
		if (!matched) {
            		this.sendReplyBox('The tier entry "'+target+'" was not found.');
            		return false;
        	}
	},
	...
	forums: function(target, room, user) {
		...
		if (!target) {
			matched = true;
			this.sendReplyBox('- <a href="http://pokecyber.createaforum.com/index.php" target="_blank">Our very own Poke Cyber forums!</a><br />');
		}
	},
